...
readout field. This field supports excavation anomaly readout,
...
component-indexed anomaly readout field computation from screened
rock--machine edges.
...
\]
aggregates those relations into a component-indexed geological anomaly readout
...
excavation-step geological anomaly readout field computed by aggregating weighted
...
component-indexed anomaly readout field.
...
\subsection{Component-indexed anomaly readout field computation}
\label{sec:interpretable_computation}
Once the graph is constructed, the central graph computation is to aggregate
screened rock--machine edges into a component-indexed anomaly readout field.
Response alignment and edge-level query are downstream readouts of this
field rather than separate method branches.

\begin{algorithm}[htbp]
\caption{Component-indexed anomaly readout field computation}
...
$\Delta I_c(t)$, it forms the component $\times$ excavation-step anomaly
readout field. $A_c(t)$ is retained as an auxiliary exposure readout, not as
part of the anomaly readout field itself. In this paper, ``field'' refers to a
discrete readout over the product domain of TBM components and excavation
